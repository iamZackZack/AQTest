// This is the Schema for the Questions in German that are retrieved from MongoDB.
// It essentially contains all the necessary fields(keys) and the value types. They are practically the same as the Question.js schema (English version).
      ...
      items: [
        {
          ...
          choiceCImage: { type: String },
          choiceDImage: { type: String },
        },
      ],
    },
  ],
